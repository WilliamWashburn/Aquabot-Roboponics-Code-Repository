...
//Remember that you changed the device to single reading mode. Go read the datasheet:  https://www.atlas-scientific.com/_files/_datasheets/_circuit/EC_EZO_Datasheet.pdf
//Send 'R' with carriage return to return a reading
...
void serialEvent1() {                                 //if the hardware serial port_3 receives a char
  ...
  Serial.print("SensorString is : ");Serial.println(sensorstring);
